	...
	$(function() {ldelim}
		$('#{$uploadWizardId}').pkpHandler(
			...
			{ldelim}
				...
				cancelButtonText: {translate|json_encode key="fileUpload.ppr.cancel"},
				continueButtonText: {translate|json_encode key="fileUpload.ppr.continue"},
				finishButtonText: {translate|json_encode key="fileUpload.ppr.finish"},
