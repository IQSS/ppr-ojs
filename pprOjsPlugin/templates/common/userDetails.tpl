...
{fbvFormArea id="userDetails"}
	{fbvFormSection title="user.name"}
		...
		{/if}
		{fbvElement type="text" label="user.familyName" multilingual="true" name="familyName" id="familyName" value=$familyName maxlength="255" inline=true size=$fbvStyles.size.MEDIUM required=$familyNameRequired}
	{/fbvFormSection}
